...
var fichesController = _db.controllers && _db.controllers.fiches;
var playlistsController = _db.controllers && _db.controllers.playlists;
...
exports.default = function (app) {
  ...
  if (fichesController) {
    ...
    console.warn((0, _unsupportedMessage2.default)('fiches routes'));
  }
  ...
  if (playlistsController) {
    ...
    console.warn((0, _unsupportedMessage2.default)('playlists routes'));
  }
};
